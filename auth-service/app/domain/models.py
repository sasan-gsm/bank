...
from sqlalchemy import String, Boolean, ForeignKey, Table, Integer, Column
...
class User(SQLAlchemyBaseUserTable[int], BaseModel):
    ...
    # Custom fields with proper Mapped[] annotations
    ...
    # Note: email, hashed_password, is_active, is_superuser, is_verified
...
class OTP(BaseModel):
    ...
    code: Mapped[str] = mapped_column(String(10), nullable=False, comment="OTP code")
